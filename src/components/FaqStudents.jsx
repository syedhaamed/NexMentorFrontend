        ...
        <div className='w-full h-auto flex flex-col'>
            ...
            <div className='w-full h-auto flex flex-col px-5 gap-5 xl:px-10'>
                <div className='w-full h-auto flex flex-col'>
                    ...
                    <p className='text-sm sm:text-sm md:text-base lg:text-lg my-3'> Use the chat system to discuss and agree on the date and time that works for both you and the mentor. The mentor will send a <span className='font-bold'>Google Meet link</span> or any other video conferencing link before the session starts.</p>
                    ...
                    <p className='text-sm sm:text-sm md:text-base lg:text-lg my-3'>After the session ends, the mentor will update the session status to <span className='font-bold'>Completed</span>. You’ll see this change in your account, and you will have the option to rate the session with a 5-star rating and provide detailed feedback.</p>
                    <h1 className='text-base sm:text-lg md:text-xl lg:text-2xl font-bold mt-4'>8. Can I get a refund if I cancel my session?</h1>
                    <p className='text-sm sm:text-sm md:text-base lg:text-lg my-3'>Yes, if you cancel your session before the mentor approves it, you are eligible for a <span className='font-bold'>Full Refund</span>. Once approved, cancellations do not qualify for a refund. For more details, check our <span className='font-bold'>Refund Policy.</span></p>
